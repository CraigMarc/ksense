let patientList = [
    {
        "data": [
            ...
            },
            {
                ...
                "diagnosis": "Test_Hypertension",
                "medications": "AssessmentDrug 20mg"
            },
            {
                "patient_id": "DEMO005",
                ...
                "diagnosis": "Fever_Assessment",
                "medications": "TestFlu 75mg"
            },
            {
                "patient_id": "DEMO006",
                "name": "EdgeCase, Diana",
                ...
                "diagnosis": "Elderly_Checkup",
                "medications": "DemoAspirin 81mg daily"
            },
            {
                "patient_id": "DEMO007",
                ...
                "diagnosis": "High_Fever",
                "medications": "TestAntibiotic 500mg TID"
            },
            {
                "patient_id": "DEMO008",
                ...
                "diagnosis": "Severe_Fever",
                "medications": "AssessmentMed 850mg BID"
            },
            {
                "patient_id": "DEMO009",
                ...
                "diagnosis": "Mild_Fever",
                "medications": "DemoMed 50mg"
            },
            {
                "patient_id": "DEMO010",
                "name": "FinalTest, Ivy",
            ...
            },
            {
                ...
                "diagnosis": "Critical_Assessment",
                "medications": "MaxDose 100mg QID"
            },
            {
                "patient_id": "DEMO013",
                "name": "Normal, Sarah",
            ...
            },
            {
                ...
                "diagnosis": "Stage2_Hypertension",
                "medications": "Lisinopril 20mg, Hydrochlorothiazide 25mg"
            },
            {
                "patient_id": "DEMO017",
            ...
            },
            {
                ...
                "temperature": 99,
                "visit_date": "2024-01-31",
                "diagnosis": "Elevated_BP",
            ...
            },
            {
                ...
                "diagnosis": "Geriatric_Care",
                "medications": "Multiple daily meds"
            },
            {
                "patient_id": "DEMO020",
                "name": "Elderly, Walter",
                ...
                "diagnosis": "Hypertension_Elderly",
                "medications": "Losartan 100mg, Metoprolol 50mg"
            },
            {
                "patient_id": "DEMO021",
                "name": "Fever, Amanda",
                ...
                "medications": "Acetaminophen 650mg"
            }
        ],
        "pagination": {
            "page": 1,
        ...
        "metadata": {
            "timestamp": "2025-07-24T19:57:48.851Z",
            "version": "v1.0",
            "requestId": "iad1::4qtrd-1753387068686-fd74a17eb3f8"
        }
    },
    {
        "data": [
            {
                ...
                "diagnosis": "Hypothermia_Risk",
                "medications": "Warming protocol"
            },
            {
                "patient_id": "DEMO023",
                ...
                "diagnosis": "Incomplete_Data",
                "medications": "Unknown dosage"
            },
            {
                "patient_id": "DEMO024",
                ...
                "diagnosis": "Data_Entry_Error",
                "medications": "Correcting records"
            },
            {
                "patient_id": "DEMO025",
                "name": "Young, Emma",
            ...
            },
            {
                ...
                "medications": "Metformin 1000mg BID, Insulin"
            },
            {
                "patient_id": "DEMO028",
            ...
            },
            {
                ...
                "diagnosis": "Hypertensive_Crisis",
                "medications": "Emergency protocol"
            },
            {
                "patient_id": "DEMO032",
                "name": "Critical, Nancy",
                ...
                "diagnosis": "Malignant_Hypertension",
                "medications": "ICU admission"
            },
            {
                "patient_id": "DEMO033",
                "name": "Cardiac, Paul",
                ...
                "medications": "Carvedilol 25mg, Aspirin 81mg"
            },
            {
                "patient_id": "DEMO034",
            ...
            },
            {
                ...
                "diagnosis": "Missing_Age",
                "medications": "Age verification needed"
            },
            {
                "patient_id": "DEMO036",
                ...
                "diagnosis": "Equipment_Malfunction",
                "medications": "Recheck vitals"
            },
            {
                "patient_id": "DEMO037",
                ...
                "diagnosis": "Severe_Fever",
                "medications": "Antipyretics, IV fluids"
            },
            {
                "patient_id": "DEMO038",
                "name": "Septic, Rachel",
            ...
            },
            {
                ...
                "diagnosis": "Menopause_Care",
                "medications": "HRT therapy"
            },
            {
                "patient_id": "DEMO041",
                "name": "VeryOld, Ernest",
        ...
        "metadata": {
            "timestamp": "2025-07-24T19:57:49.104Z",
            "version": "v1.0",
            "requestId": "iad1::4qtrd-1753387068952-e10e7aa1c66a"
        }
    },
    {
        "data": [
            {
                ...
                "diagnosis": "Adolescent_Care",
                "medications": "Acne treatment"
            },
            {
                "patient_id": "DEMO043",
                ...
                "diagnosis": "Data_Entry_Error",
                "medications": "Age correction needed"
            },
            {
                "patient_id": "DEMO044",
                "name": "noissue, Lisa",
                ...
                "diagnosis": "noissue",
                "medications": "Validation required"
            },
            {
                "patient_id": "DEMO045",
                ...
                "diagnosis": "Multiple_Conditions",
                "medications": "Lisinopril 20mg, Metformin 1000mg, Atorvastatin 40mg, Aspirin 81mg, Metoprolol 100mg"
            },
            {
                "patient_id": "DEMO046",
                "name": "NoMeds, Kelly",
            ...
            },
            {
                ...
                "diagnosis": "Borderline_Fever",
                "medications": "Monitor symptoms"
            },
            {
                "patient_id": "DEMO048",
                ...
                "diagnosis": "Final_Assessment",
                "medications": "Follow-up required"
            }
        ],
        "pagination": {
            "page": 3,
        ...
        "metadata": {
            "timestamp": "2025-07-24T19:57:49.342Z",
            "version": "v1.0",
